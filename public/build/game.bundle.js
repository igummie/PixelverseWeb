...
const CHAT_BUBBLE_FADE_MS = 1700;
const LEAVE_TEXT_FADE_MS = 4000;
...
const DEBUG_INFO_REFRESH_MS = 120;
...
function getGemFrameForValue(value, gemValueToFrame) {
...
function createHudController({ state, screens, canvas, ctx, elements, settings }) {
  const {
    zoomLevel,
    gemCount,
    debugOverlay,
